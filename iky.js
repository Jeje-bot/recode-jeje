...
join = 'Haii Kawannn, *Selamat Datang*\nTerima Kasih Telah Join Di Group Ini, *Jangan Lupa Baca Deskripsi dan Ikuti Rulesnya.*'
leave = '*"Selamat Tinggal👋"*\nSemoga Harimu Menyenangkan di Luar Sana.....!'
const simple = require('./lib/simple.js')
let fakeimage = fs.readFileSync("./media/wpmobile.png")
let errorImg = 'https://i.ibb.co/wJzkz7s/IMG-20211018-WA0043.jpg'
...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
        ...
        ////DAFTAR BUTTON 
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Nahara X IkyAdsVerify Terlebih Dahulu Ya `
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6281218871040`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
       ...
       break
                ...
                case 'boke91owowp': case 'bkpwow9q9oaos': case 'randowowoiwisjsjsmbokep':{
                if (!isPremium) return reply(mess.OnlyPrem)
...
Made With ❤️ in Tangerang, Balaraja ,Indonesia
...
Jangan Lupa
${prefix}sewa
JANGAN TERLALU SERING ${prefix}MENU AGAR GA NGEBUG`)
		}, 2000)
...
case 'lock':
 ikymemek = {
  "key": {
    "fromMe": false,
    participant: `6281218871040@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
🐥 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created Nahara X IkyAds`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `Nahara X IkyAds`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @exhar_ft`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Nahara X IkyAds', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @exhar_ft`,buttons,headerType:4}
...
`
   sendButMessage(from, wibu, `Developer by Muhamad Nahara`, [
          {
			...
			case 'blur':
				...
				case 'circle':
                  ...
                  case 'wanted':
					...
					break
case 'chiisaio949eiejdjsiw8wiwjhentai':
                case 'henta9298wisjdjehhehei4everyone':
                reply (mess.wait)
              ...
              ikyy.relayWAMessage(prep)
                    ...
                    break
                case 'n9w9woksksksosowow99wowowowsfw_avatar':
                reply (mess.wait)
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${setting.lolkey}&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Nahara X IkyAdsT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @exhar_ft`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
`
 ...
 Nahara X IkyAds︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
✨ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
✨ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡at𝐬 : *${privat.length}*
✨ 𝐓ot𝐚𝐥 𝐂𝐡𝐚t𝐬 : *${totalChat.length}*
✨ 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
✨ 𝐀cti𝐯𝐞 : *${runtime(process.uptime())}*
✨ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
Made With ❤️ Tangerang,Balaraja,Indonesia
...
⬡ 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔
*FITUR INI TELAH DI HAPUS OLEH DEVELOPER* ,Silahkan Gunakan Fitur Lain dengan Baik!
 `

               sendButMessage(from, menu, `Developer  by  @exhar_ft`, [
          {
...
`
 ...
 Nahara X IkyAds︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`verify`,`groupmenu`,`groupsetting`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`storymenu`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`ikyygroup`,`sewabot`]
               listmenuu = [`Daftar Ke Database`,`Menu Group`,`Setelan Group`,`Photo Oky`,`Image Maker`,`Ephoto Menu`,`Random Image`,`Movie&Story`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated Nahara X IkyAds︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*「 Nahara X IkyAds︎ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di Nahara Botz🐥*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/8KTW0Fj/20211102-021951.png'
...
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `Premium`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Nahara X IkyAds︎ ', imageMessage: imageMsg,
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
      ...
      case 'payment':
      case 'pay':
              gopeynya = 'https://i.ibb.co/wJzkz7s/IMG-20211018-WA0043.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `
┏━━⬣ PAYMENT!
┃⬡ GOJEK 
...
ikyy.sendMessage(from,{url:'./'+kyyyy},audio,{mimetype:'audio/mpeg'})
  ...
  case 'xnx9292828e8eisjnsjexs':
                    ...
                    reply(ini_txt)
                    break
                case '938ridjdnsnwkwo0w0woskxnxx':
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1}]
       ...
       case 'src':
            ...
            buff = await getBuffer(gopeynya)
            teksnya = `◁━━━━◈✙◈━━━━▷
SCRIPT NO ENC + EASY EDIT, BUY THIS SOURCE CODE FOR *Rp.40.000*
Hub A Developer : wa.me/6281218871040
━━━━━━━ •♬• ━━━━━━━
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Pengembang IkyAds Dan Muhamad Nahara', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
              break
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 Nahara Broadcast 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*「 Nahara Broadcast 」*\n\n${body.slice(4)}`,
			"footerText": 'Muhamad Nahara',
			"buttons": [
			{"buttonId": `#menu`,
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://i.ibb.co/wJzkz7s/IMG-20211018-WA0043.jpg'
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6281218871040@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6281218871040@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('6281218871040@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Enable/Disable >-------------------
       ...
       case 'welcome':
        ...
        case 'grubset':
               ...
               listnya = [`Setelan Mengirim Pesan`,`Peserta Bisa Naik Level`,`Peserta Baru/Keluar Akan di Sambut`,`Peserta Akan Di Kick Jika Mengirim Link Grup`,`Hanya Admin Yang Bisa Menggunakan Bot`]
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Follow = Donasi, Bagi kami 🙂 https://www.instagram.com/exhar_ft/`)
             break
      case 'ikyygroup':
             reply('https://chat.whatsapp.com/DlhWWXjtLox7NwUX5qjc86')
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
